...
export default function Notices() {
  ...
  <div className="overflow-auto">
    <table className="min-w-full text-sm">
      <thead className="bg-gray-50"><th className='px-3 py-2 text-left font-medium'>Title</th><th className='px-3 py-2 text-left font-medium'>From</th><th className='px-3 py-2 text-left font-medium'>Date</th></thead>
