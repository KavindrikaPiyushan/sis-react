...
export default function Results() {
  ...
  <div className="overflow-auto">
    <table className="min-w-full text-sm">
      <thead className="bg-gray-50"><th className='px-3 py-2 text-left font-medium'>Course Code</th><th className='px-3 py-2 text-left font-medium'>Course</th><th className='px-3 py-2 text-left font-medium'>Credits</th><th className='px-3 py-2 text-left font-medium'>Grade</th></thead>
