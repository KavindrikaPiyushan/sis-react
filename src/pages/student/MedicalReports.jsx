...
export default function MedicalReports() {
  ...
  <div className="overflow-auto">
    <table className="min-w-full text-sm">
      <thead className="bg-gray-50"><th className='px-3 py-2 text-left font-medium'>Report #</th><th className='px-3 py-2 text-left font-medium'>Date</th><th className='px-3 py-2 text-left font-medium'>Status</th><th className='px-3 py-2 text-left font-medium'>Remarks</th></thead>
