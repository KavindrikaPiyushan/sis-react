...
export default function PaymentApprovals() {
  ...
  <div className="overflow-auto">
    <table className="min-w-full text-sm">
      <thead className="bg-gray-50"><th className='px-3 py-2 text-left font-medium'>Receipt #</th><th className='px-3 py-2 text-left font-medium'>Student</th><th className='px-3 py-2 text-left font-medium'>Amount</th><th className='px-3 py-2 text-left font-medium'>Status</th></thead>
