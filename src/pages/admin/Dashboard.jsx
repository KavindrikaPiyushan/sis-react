...
const AdminDashboard = () => {
  ...
  const dashboardCards = allDashboardCards.filter((card) => {
    if (userRole === "super_admin" && card.title === "Total Students") {
      return false; // Hide "Total Students" for super_admin
    }
      ...
      <div className="p-6  ">
        ...
        <div className="mb-8 pb-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mb-0">
            Welcome to the Faculty of Technology Student Information System
          </p>
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-2 ${
            userRole === "super_admin" ? "lg:grid-cols-3" : "lg:grid-cols-4"
          } gap-6 mb-8`}
        >
        ...
        {/* Charts Section */}
        {userRole !== "super_admin" && (<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-md mb-8">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600">
              Latest system activities and pending items
            </p>
          </div>
                ...
                {recentActivities.map((activity, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${activity.statusColor}`}
                      >
                        {activity.status}
                      </span>
                    </td>
        ...
        {/* Quick Actions */}
          {userRole !== "super_admin" && ( <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
